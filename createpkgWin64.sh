...
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osg.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgDB.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgFX.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgGA.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgQt.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgShadow.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgText.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgUtil.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osg100-osgViewer.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/build/bin/ot20-OpenThreads.dll $PKGDIR/bin
mkdir $PKGDIR/bin/osgPlugins-3.2.1
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osgPlugins-3.2.1/osgdb_png.dll $PKGDIR/bin/osgPlugins-3.2.1
cp $ROOT/../librs/deps/osg3.2.1/build/bin/osgPlugins-3.2.1/osgdb_3ds.dll $PKGDIR/bin/osgPlugins-3.2.1
cp $ROOT/../librs/deps/osg3.2.1/third_party/x64/bin/glut32.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/third_party/x64/bin/libpng13.dll $PKGDIR/bin
cp $ROOT/../librs/deps/osg3.2.1/third_party/x64/bin/zlib1.dll $PKGDIR/bin
